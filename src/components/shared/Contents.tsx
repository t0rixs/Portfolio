...
export const contents = [
    ...
    new Content("tapaz", "Activity", "Tapaz", "学生の視点を用いて経営者と新しい価値を提案する事業活動", new Date(2024, 11, 11), ["Business"], "Note", "https://note.com/tapaz", `${import.meta.env.BASE_URL}img/tapaz_all.png`, 0.6, null),
